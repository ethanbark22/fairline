...
const ODDS = `match_id,pinnacle_1x2_home_close,pinnacle_1x2_draw_close,pinnacle_1x2_away_close,market_avg_1x2_home_close,market_avg_1x2_draw_close,market_avg_1x2_away_close,market_max_1x2_home_close,market_max_1x2_draw_close,market_max_1x2_away_close
1213-arsenal-sunderland,1.35,5.2,10.5,,,,1.4,5.5,11
...
describe("loadHistoricalMatches", () => {
  it("joins results with closing odds", () => {
    ...
    expect(first.odds.maxClose).toEqual({ home: 1.4, draw: 5.5, away: 11 });
  });
